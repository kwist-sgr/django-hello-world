...
class BaseDjangoFactory(factory.DjangoModelFactory):
...
class UserFactory(BaseDjangoFactory):
    FACTORY_FOR = User
...
class ProfileFactory(BaseDjangoFactory):
    FACTORY_FOR = Profile

    user = factory.SubFactory(UserFactory)


class StoredHttpRequestFactory(BaseDjangoFactory):
...
class ModelActionFactory(BaseDjangoFactory):
    FACTORY_FOR = ModelAction

    model_pk = factory.Sequence(lambda n: n)
