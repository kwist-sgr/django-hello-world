...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoredHttpRequest.priority'
        db.add_column(u'hello_storedhttprequest', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StoredHttpRequest.priority'
        db.delete_column(u'hello_storedhttprequest', 'priority')
    ...
    models = {
        ...
        u'hello.storedhttprequest': {
            'Meta': {'ordering': "['-priority', 'id']", 'object_name': 'StoredHttpRequest'},
