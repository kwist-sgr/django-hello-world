...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoredHttpRequest'
        db.create_table(u'hello_storedhttprequest', (
            ...
            ('full_path', self.gf('django.db.models.fields.TextField')(max_length=500)),
            ('user_agent', self.gf('django.db.models.fields.TextField')(max_length=300, null=True)),
            ('referer', self.gf('django.db.models.fields.TextField')(max_length=300, null=True)),
