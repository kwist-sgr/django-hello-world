...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'hello_profile', (
            ...
            ('bio', self.gf('django.db.models.fields.TextField')(max_length=600, null=True, blank=True)),
            ('jabber', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('skype', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('contacts', self.gf('django.db.models.fields.TextField')(max_length=600, null=True, blank=True)),
        ))
