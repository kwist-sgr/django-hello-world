...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelAction'
        db.create_table(u'hello_modelaction', (
        ...
        db.send_create_signal(u'hello', ['ModelAction'])

    def backwards(self, orm):
        # Deleting model 'ModelAction'
        db.delete_table(u'hello_modelaction')
